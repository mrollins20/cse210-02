...
class Card:
    def __init__(self):
        self.suites = ["Diamond", "Spade", "Clubs", "Hearts"]
        self.card_suit = random.choices(self.suites)
    ...
    def draw_card(self, _t):
        ...
        score = 0
        self.points = 100 if self.value >= score.hilo else -75 if self.value <= score.hilo else 0